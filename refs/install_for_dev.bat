...
helm install cert-manager ./cert-manager --namespace cert-manager --create-namespace --set installCRDs=true
...
git stash
# Thực hiện pull
git pull origin nganptm/#3
# Khôi phục các thay đổi đã stash
git stash pop
